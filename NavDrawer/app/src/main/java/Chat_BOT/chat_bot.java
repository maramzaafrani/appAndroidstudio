...
public class chat_bot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRequestQueue = Volley.newRequestQueue(chat_bot.this);
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(chat_bot.this, RecyclerView.VERTICAL, false);
    ...
    private void sendMessage(String userMsg) {
        ...
        String url = "http://api.brainshop.ai/get?bid=166847&key=P3hmQHwS4yRKMxIr&uid=[uid]&msg=[msg]\n" + userMsg;
        //creating a variable for our request queue.
        RequestQueue queue = Volley.newRequestQueue(chat_bot.this);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest( Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(chat_bot.this, "No response from the bot..", Toast.LENGTH_SHORT).show();
            }
        });
